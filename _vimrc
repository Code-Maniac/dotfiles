...
set guifont=ProggyCleanTT:h12:cANSI:qDRAFT
...
set smarttab
set list
set listchars=tab:>-,trail:~ "highlight tabs with an arrow. eol with ¬. trailing whitespace with ~.
...
" supertab completion goes down instead of up
